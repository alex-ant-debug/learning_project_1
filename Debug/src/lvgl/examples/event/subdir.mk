...
../src/lvgl/examples/event/lv_example_event_3.c 

OBJS += \
./src/lvgl/examples/event/lv_example_event_1.o \
./src/lvgl/examples/event/lv_example_event_2.o \
./src/lvgl/examples/event/lv_example_event_3.o 

C_DEPS += \
./src/lvgl/examples/event/lv_example_event_1.d \
./src/lvgl/examples/event/lv_example_event_2.d \
./src/lvgl/examples/event/lv_example_event_3.d 


# Each subdirectory must supply rules for building sources it contributes
src/lvgl/examples/event/%.o: ../src/lvgl/examples/event/%.c
	@echo 'Building file: $<'
