...
../src/lvgl/examples/porting/lv_port_fs_template.c \
../src/lvgl/examples/porting/lv_port_indev_template.c 

OBJS += \
./src/lvgl/examples/porting/lv_port_disp_template.o \
./src/lvgl/examples/porting/lv_port_fs_template.o \
./src/lvgl/examples/porting/lv_port_indev_template.o 

C_DEPS += \
./src/lvgl/examples/porting/lv_port_disp_template.d \
./src/lvgl/examples/porting/lv_port_fs_template.d \
./src/lvgl/examples/porting/lv_port_indev_template.d 


# Each subdirectory must supply rules for building sources it contributes
src/lvgl/examples/porting/%.o: ../src/lvgl/examples/porting/%.c
	@echo 'Building file: $<'
