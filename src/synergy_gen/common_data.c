...
const display_cfg_t g_display_cfg =
        ...
        .input[0
          ...
          .line_detect_ipl = (3),
          .underflow_1_ipl = (3), .underflow_2_ipl = (BSP_IRQ_DISABLED), };
...
#if (1)
uint8_t g_sf_el_gx_jpegbuffer[1] BSP_ALIGN_VARIABLE_V2(64) BSP_PLACE_IN_SECTION_V2(".bss");
#endif
#endif
...
void sf_message_init0(void)
{
    ...
    ssp_err_g_sf_message = g_sf_message.p_api->open (g_sf_message.p_ctrl, g_sf_message.p_cfg);
